	...
	*/
	...
	private void runCycle() {
		...
		do { 
			...
			nextEvent();
		} while ((((((((((((((((leftBump || rightBump) || senseFall) || senseWall) || detectObject) || reachDestination) || writeButton) || stopWriting) || moveButton) || stopMoving) || timeEvents[0]) || timeEvents[1]) || timeEvents[2]) || timeEvents[3]) || timeEvents[4]) || timeEvents[5]));
